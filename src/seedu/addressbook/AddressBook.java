...
public class AddressBook {
    ...
    private static final String PERSON_DATA_PREFIX_DATEOFBRITH = "d/";

    private static final String PERSON_STRING_REPRESENTATION = "%1$s " // name
                                                            + PERSON_DATA_PREFIX_PHONE + "%2$s " // phone
                                                            + PERSON_DATA_PREFIX_EMAIL + "%3$s " // email
                                                            + PERSON_DATA_PREFIX_DATEOFBRITH + "%4$s"; // date of birth
    private static final String COMMAND_ADD_WORD = "add";
    private static final String COMMAND_ADD_DESC = "Adds a person to the address book.";
    private static final String COMMAND_ADD_PARAMETERS = "NAME "
                                                      + PERSON_DATA_PREFIX_PHONE + "PHONE_NUMBER "
                                                      + PERSON_DATA_PREFIX_EMAIL + "EMAIL"
                                                      + PERSON_DATA_PREFIX_DATEOFBRITH + "DATE_OF_BIRTH";
    private static final String COMMAND_ADD_EXAMPLE = COMMAND_ADD_WORD + " John Doe p/98765432 e/johnd@gmail.com d/11021997";
    ...
    private static final int PERSON_DATA_INDEX_DATEOFBIRTH = 3;
    ...
    private static boolean hasValidFileName(Path filePath) {
        boolean fileIsRegular = Files.isRegularFile(filePath);
        boolean fileDoesNotExist = !Files.exists(filePath);
        boolean fileHasExtension = filePath.getFileName().toString().lastIndexOf('.') > 0;
        return fileHasExtension && (fileDoesNotExist || fileIsRegular);
    }
    ...
    private static String executeCommand(String userInputString) {
        ...
        case COMMAND_SORT_WORD:
            return executeSortAllPersonsInAddressBookInAlphabeticalOrder();
    ...
    private static String getMessageForSuccessfulAddPerson(String[] addedPerson) {
        return String.format(MESSAGE_ADDED, getNameFromPerson(addedPerson),
                ...
                getDateOfBirthFromPerson(addedPerson));
    }
     ...
     * @return feedback display message for the operation result
     */
    private static String executeSortAllPersonsInAddressBookInAlphabeticalOrder() {
        ...
        return getMessageForPersonsDisplayedSummary(sortedToBeDisplayed);
    }
    ...
    */
    ...
    private static String getDateOfBirthFromPerson(String[] person) {
        return person[PERSON_DATA_INDEX_DATEOFBIRTH];
    }
     ...
     */
    private static String[] makePersonFromData(String name, String phone, String email, String dateOfBirth) {
        ...
        person[PERSON_DATA_INDEX_DATEOFBIRTH] = dateOfBirth;
        return person;
    }
    ...
    private static boolean isPersonDataExtractableFrom(String personData) {
        final String matchAnyPersonDataPrefix = PERSON_DATA_PREFIX_PHONE + '|' + PERSON_DATA_PREFIX_EMAIL + '|' + PERSON_DATA_PREFIX_DATEOFBRITH;
    ...
    private static String extractEmailFromPersonString(String encoded) {
        final int indexOfEmailPrefix = encoded.indexOf(PERSON_DATA_PREFIX_EMAIL);
        final int indexOfDateOfBirthPrefix = encoded.indexOf(PERSON_DATA_PREFIX_DATEOFBRITH);

        // email is last arg, target is from prefix to end of string
        if (indexOfEmailPrefix > indexOfDateOfBirthPrefix) {
        ...
        // email is middle arg, target is from own prefix to next prefix
            ...
            return removePrefixSign(
                    encoded.substring(indexOfEmailPrefix, indexOfDateOfBirthPrefix).trim(),
                    PERSON_DATA_PREFIX_EMAIL);
        }
    }
    ...
    private static String extractDateOfBirthFromPersonString(String encoded) {
        ...
        return removePrefixSign(encoded.substring(indexOfDateOfBirthPrefix, encoded.length()).trim(),
                PERSON_DATA_PREFIX_DATEOFBRITH);
    }
    ...
    private static boolean isPersonDataValid(String[] person) {
        return isPersonNameValid(person[PERSON_DATA_INDEX_NAME])
                ...
                && isPersonDateOfBirthValid(person[PERSON_DATA_INDEX_DATEOFBIRTH]);
    }
     ...
     * Returns true if the given string is a legal person email
     *
     * @param dateOfBirth to be validated
     * @return whether arg is a valid person email
     */
    private static boolean isPersonDateOfBirthValid(String dateOfBirth) {
        return dateOfBirth.matches("[0-3]+[0-9]+[0-1]+[0-9]+[1-2]+[0-9]+[0-9]+[0-9]+"); // date of birth is DDMMYYYY
        //TODO: implement a more permissive validation
    }
